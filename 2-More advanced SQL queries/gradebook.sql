...
-- In this first step, select all of the rows,
-- and display the name, number_grade, and percent_completed,
-- which you can compute by multiplying by 100 and rounding the fraction_completed column.
